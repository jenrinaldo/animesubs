		...
		<div class="respond">
			...
			<p>You must be 
				<a href="
					...
					<?php echo urlencode(get_permalink()); ?>">logged in
				</a> to post a comment.
			</p>
			<?php else : ?>
			<form action="
				...
				<p>Logged in as 
					...
					<a href="
						<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out &raquo;
					</a>
				</p>
				<?php else : ?>
				<?php endif; ?>
				<p>
					<textarea name="comment" id="comment" placeholder="Join the Discussion..." cols="100%" rows="10" tabindex="4"></textarea>
				</p>
				<input type="text" name="author" id="author" placeholder="Name" value="
					...
					<p>
						<input type="text" name="email" id="email" placeholder="Email" value="
							...
							<?php if ($req) echo "aria-required='true'"; ?> />
							<div class="kaskusonclick" style="margin-top: 20px;">
...
?>
							...
							<div class="
								<?php echo $oddcomment; ?>
								<?php if ($first) { echo ' first'; $first = false; } ?>" id="comment-
								<?php comment_ID() ?>">
							...
							<form action="
								...
								<p>Logged in as 
									...
									<a href="
										<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="Log out of this account">Logout &raquo;
									</a>
								</p>
								<?php else : ?>
								<p>
									<input size="36" type="text" name="author" /> Name 
									<span class="required">*</span>
								</p>
								<p>
									<input size="36" type="text" name="email" /> Mail 
									<span class="required">*</span>
								</p>
								<?php endif; ?>
								<p>
									<textarea rows="12" cols="42" name="comment"></textarea>
								</p>
								<p>
